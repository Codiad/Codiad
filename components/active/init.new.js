...
(function(global, $) {
    ...
    codiad.active = {
        ...
        init: function() {
            ...
            // Focus from list.
            $(document)
                .on('click', '#list-active-files a', function(e) {
                    e.stopPropagation();
            ...
            $(document)
                .on('click', '#dropdown-list-active-files a', function(e) {
                    if(e.which == 1) {
            ...
            $(document)
                .on('mousedown', '#tab-list-active-files li.tab-item>a.label', function(e) {
                    if(e.which == 1) {
                        e.stopPropagation();
                        _this.focus($(this).parent('li').attr('data-path'));
                    }
            ...
            // Remove from list.
            $(document)
                .on('click', '#list-active-files a>span', function(e) {
                e.stopPropagation();
                _this.remove($(this)
                    .parent('a')
                    .parent('li')
            ...
            $(document)
                .on('click', '#dropdown-list-active-files a>span', function(e) {
                e.stopPropagation();
            ...
            // Remove from tab.
            $(document)
                .on('click', '#tab-list-active-files a.close', function(e) {
                e.stopPropagation();
                /* Get the active editor before removing anything. Remove the
                 * tab, then put back the focus on the previously active
                 * editor if it was not removed. */
            ...
            $(document)
                .on('mouseup', '#dropdown-list-active-files li', function(e) {
                    if (e.which == 2) {
                        e.stopPropagation();
                        /* Get the active editor before removing anything. Remove the
                         * tab, then put back the focus on the previously active
            ...
            $(document)
                .on('mouseup', '.tab-item', function(e) {
                    if (e.which == 2) {
                        e.stopPropagation();
                        /* Get the active editor before removing anything. Remove the
                         * tab, then put back the focus on the previously active

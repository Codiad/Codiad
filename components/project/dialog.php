    ...
    */
    ...
    switch($_GET['action']){
        ...
        case 'list':
            ...
            foreach($projects as $project=>$data){
                ...
                <tr>
                    ...
                    <td><?php if($data['path']!='') { echo($data['path']); } else { echo ''; }; ?></td>
                    <?php
                        if(!$projects_assigned){
                            ...
                            ?>
                            <td><a onclick="codiad.message.error('Master Project Cannot Be Removed');" class="icon-block bigger-icon"></a></td>
                            <?php
                            }else{             
                            ?>
            ...
            <?php if(!$projects_assigned){ ?><button class="btn-left" onclick="codiad.project.create('false');">New Project</button>&nbsp;<?php } ?><button class="<?php if(!$projects_assigned){ echo('btn-right'); } ?>" onclick="codiad.modal.unload();return false;">Close</button>
            <?php
        ...
        ?>
            ...
            <tr><td width="5"><input type="checkbox" name="follow" id="follow" value="true"></td><td>Delete Files behind Symbolic Links </td></tr>
            </table>

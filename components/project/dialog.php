    ...
    */
    ...
    switch($_GET['action']){
        ...
        case 'list':
                ...
                <tr>
                    ...
                    <?php
                        if(checkAccess()){
                            ...
                            ?>
                            <td><a onclick="codiad.message.error('<?php i18n('Active Project Cannot Be Removed') ?>');" class="icon-block bigger-icon"></a></td>
                            <?php
                            }else{
                            ?>
            ...
            <?php if(checkAccess()){ ?><button class="btn-left" onclick="codiad.project.create();"><?php i18n('New Project') ?></button><?php } ?><button class="<?php if(checkAccess()){ echo('btn-right'); } ?>" onclick="codiad.modal.unload();return false;"><?php i18n('Close') ?></button>
            <?php
        ...
        case 'create':
            ...
            ?>
            <button class="btn-left"><?php i18n('Create Project') ?></button><button onclick="$('#git-clone').slideDown(300); $(this).hide(); return false;" class="btn-mid">...<?php i18n('From Git Repo') ?></button><button class="btn-right" onclick="<?php echo $action;?>return false;"><?php i18n('Cancel') ?></button>
            <form>
            <?php
            break;
        ...
        <button class="btn-left"><?php i18n('Rename') ?></button>&nbsp;<button class="btn-right" onclick="codiad.modal.unload(); return false;">Cancel</button>
        <form>
        <?php
        break;

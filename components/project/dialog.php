    ...
    switch($_GET['action']){
        ...
        case 'list':
            ...
            foreach($projects as $project=>$data){
                ...
                ?>
                <tr>
                    <td><a onclick="codiad.project.open('<?php echo($data['path']); ?>');" class="icon-folder"></a></td>
                    ...
                    <?php
                        if(!$projects_assigned){
                            ...
                            ?>
                            <td><a onclick="codiad.message.error('Active Project Cannot Be Removed');" class="icon-block"></a></td>
                            <?php
                            }else{
                            ?>
                            <td><a onclick="codiad.project.delete('<?php echo($data['name']); ?>','<?php echo($data['path']); ?>');" class="icon-cancel-circled"></a></td>
                            <?php
                            }
                        }
                    ?>

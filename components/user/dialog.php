    ...
    */
    ...
    switch($_GET['action']){
        ...
        case 'list':
            ...
            <tr>
                ...
                <?php
                    ...
                    ?>
                    <td><a onclick="codiad.message.error('<?php i18n('You Cannot Delete Your Own Account') ?>');" class="icon-block bigger-icon"></a></td>
                    <?php
                    }else{
                    ?>
            ...
            <button class="btn-left" onclick="codiad.user.createNew();"><?php i18n('New Account') ?></button><button class="btn-right" onclick="codiad.modal.unload();return false;"><?php i18n('Close') ?></button>
            <?php
            }
        ...
        case 'create':
            ...
            <button class="btn-left"><?php i18n('Create Account') ?></button><button class="btn-right" onclick="codiad.user.list();return false;"><?php i18n('Cancel') ?></button>
            <form>
            <?php
            break;
        ...
        ?>
            ...
            <button class="btn-left"><?php i18n('Confirm') ?></button><button class="btn-right" onclick="codiad.user.list();return false;"><?php i18n('Close') ?></button>
            <?php
            break;
        ...
        ?>
            ...
            <button class="btn-left"><?php i18n('Confirm') ?></button><button class="btn-right" onclick="codiad.user.list();return false;"><?php i18n('Cancel') ?></button>
            <?php
            break;
        ...
        ?>
            ...
            <label><?php i18n('Confirm Password') ?></label>
            <input type="password" name="password2">
            <button class="btn-left">Change <?php echo(ucfirst($username)); ?>&apos;s Password</button><button class="btn-right" onclick="codiad.modal.unload();return false;"><?php i18n('Cancel') ?></button>
            <?php
            break;

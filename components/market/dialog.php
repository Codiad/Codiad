        ...
        case 'list':
            ...
            <table width="100%">
                <tr>
                    ...
                    <th valign="middle" width="30%"><input style="margin:0;display:inline" placeholder="Search"></th>
                </tr>
             </table>
            ...
            <table width="100%">
                <tr>
                    <th valign="middle"><input style="margin:0;display:inline" placeholder="Enter GitHub Repository Url..."></th>
                    <th valign="middle" align="right" width="222px"><button class="btn-left" onclick="codiad.market.list();return false;"><?php i18n("Install Manually"); ?></button><button class="btn-right" onclick="codiad.modal.unload();return false;"><?php i18n("Close"); ?></button></th>
                </tr>
             </table>
            <?php

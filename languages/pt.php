...
$lang = array(
   ...
   "Close Unsaved File?"                                 => "Fechar arquivo não guardado?",
   "Save&close"                                          => "Guardar &amp; Fechar",
   "Discard Changes"                                     => "Descartar Modificações",
   "Cancel"                                              => "Cancelar",
   "Recovered unsaved content for: "                     => "Recuperado conteúdo não guardado para: ",
   "You have unsaved files."                             => "Você tem arquivos que não foram guardados.",
   "No Open Files to save"                               => "Não há arquivos abertos para Guardar",
   ...
   "File could not be saved"                             => "Arquivo não pode ser guardado",
   ...
   "Plugin Update Check"                                 => "Verificar Atualização de Extensão",
   "Version"                                             => "Versão",
   "Author"                                              => "Autor",
   "Active"                                              => "Ativa",

...
$lang = array(
   ...
   "Show" => "Отображать", 
   "Hide" => "Не Отображать",
   "Wrap Lines" => "Переновить по словам",
   "No wrap" => "Переносить",  
   ...
   "No Open Files to save" => "Нету открытых Файлов для сохранения",
   "No Open Files or Selected Text" => "Нету открытых файлов или выделенного текста",
